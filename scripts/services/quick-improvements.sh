...
# This script implements immediate improvements to enhance project coherence

echo "Starting quick improvements for project coherence..."
    ...
    <div class="container">
        ...
        <div class="status">
            ...
            <div class="status-item">
                ...
                <span class="status-value online">Online (Port 3003)</span>
            </div>
            <div class="status-item">
                <span class="status-label">3D Visualization</span>
                <span class="status-value online">Online (Port 8081)</span>
            </div>
            <div class="status-item">
                <span class="status-label">File Storage</span>
                <span class="status-value online">Online (Port 8080)</span>
            </div>
        </div>
    </div>
...
# Fix the backend DeleteNotebooks function
sed -i.bak '480,509s/try {/try {\n        console.log(`Attempting to delete file: ${req.params.directory}\/${req.params.file}`);/' /home/user/Repository/WebProjects/Constellation-Viewer/backend/server.js

# Start the unified interface
echo "Starting unified interface..."
cd /home/user/Repository/WebProjects/unified-interface && node server.js &

# Save the PID
echo $! > /home/user/Repository/WebProjects/unified-interface/server.pid

echo "Unified interface started at http://localhost:9000"
echo "This provides a centralized entry point to all services"
echo ""
echo "To stop the unified interface, run: kill $(cat /home/user/Repository/WebProjects/unified-interface/server.pid)"