...
Calming Leaves
Checkpoint ReachedAreas represented by reflective silver puddles that cast a white bloom; they can be seen clearly in the environs. When the reflective puddle is
...
accumulated. When they reach a specific quantity for a leaf type the ability it alters is improved slightly. It ultimately entices the player to
...
Mother Nature. This detail is primarily used when puzzles require completion; the creatures whom are affected by the chaotic forces will
...
The main characters of the game; autumn and Little, can be visually altered when these are discovered via exploration or puzzle solving. Little
can acquire various ties and Autumn can wear any of the outfits found in game, these items can be equipped at the main menu screen under
'Alter'. These items will appear on the characters for the duration of gameplay and cut scenes.
--------------------
Level Traversing
--------------------
The Equilibrium
The Equilibrium is the center of balance in the world; it quietly drifts above the tallest of trees, Autumn’s shelter in the skies. This entity acts as
the player’s level hub, enabling observation of the entire map from an incredible height.
Each of the game's levels are represented by (what entity? needs discussion)
Level Room (multiple levels all with similar themes)
Before Autumn can float down to begin an adventure, the camera pans to display each point of interest, calm creatures, and the number of
chaotic forces they will be facing. Giving the player a general understanding of what they will encounter on the ground below.
Level Example
This description will discuss the appearance of the prototype map, list keys, and points of interest.
Level Puzzles
Path Assistance
Autumn may requires assistance at times, if the player strays off path or becomes disoriented in their goals, the Equilibrium will present the
direction she must go with the glow of leaves on the ground to represent a tail for her to follow.________________
...
--------------------
SummaryOrchestral with a very string focused aesthetic (perhaps even more so specifically more centered on mid ranged stringed instruments like cellos
