// symbols-loader.js
// Loads the symbols integration for the 3D visualization
...
(function() {
    ...
    waitForSceneInit(() => {
      ...
      faces.forEach((face, index) => {
        ...
        if (index < symbolFiles.length) {
          ...
          // The server is configured to serve these files
      ...
      notification.textContent = 'Symbols integration complete - double-click to toggle orbit mode';
  ...
  loadingNotification.textContent = 'Symbols integration loading...';
